    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n' && currentLineIsBlank) {
          ...
          client.println("iMeteo.ca<br />");     
          client.println("Coin SE : temperature "+String(data[0])+" C, humidite "+String(data[1])+" %");
	  client.println("<br>");
          client.println("Coin SO : temperature "+String(data[2])+" C, humidite "+String(data[3])+" %");
